...
This will create: `lwanga_1.0.0-1_amd64.deb` (or `arm64` depending on your architecture)

## 2. Generate Checksum

```bash
sha256sum lwanga_1.0.0-1_*.deb > lwanga_1.0.0-1_amd64.deb.sha256
```
...
2. Fill in:
   - **Tag**: `v1.0.0`
   - **Release title**: `Lwanga v1.0.0 - Initial Release`
   - **Description**: 
   ```markdown
   # Lwanga v1.0.0 - Initial Release
...
3. **Attach files**:
   - Drag and drop `lwanga_1.0.0-1_amd64.deb`
   - Drag and drop `lwanga_1.0.0-1_amd64.deb.sha256`
...
# Verify checksum
sha256sum -c lwanga_1.0.0-1_amd64.deb.sha256
...
`https://github.com/cosmah/Project-Lwanga/releases/download/v1.0.0/lwanga_1.0.0-1_amd64.deb`
